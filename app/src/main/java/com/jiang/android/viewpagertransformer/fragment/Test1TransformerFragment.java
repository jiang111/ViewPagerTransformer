 ...
 */
public class Test1TransformerFragment extends TransformerFragment {
    ...
    public static Test1TransformerFragment newInstance() {

        Bundle args = new Bundle();

        Test1TransformerFragment fragment = new Test1TransformerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_test_1, null);
        mButton1 = (Button) root.findViewById(R.id.button_test1_1);
        mButton2 = (Button) root.findViewById(R.id.button_test1_2);
        mButton3 = (Button) root.findViewById(R.id.button_test1_3);
        return root;
