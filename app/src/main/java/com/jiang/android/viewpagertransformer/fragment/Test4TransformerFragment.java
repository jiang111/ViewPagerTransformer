 ...
 */
public class Test4TransformerFragment extends TransformerFragment {

    private Button mButton1;
    private Button mButton2;
    private Button mButton3;

    public static Test4TransformerFragment newInstance() {
        
        Bundle args = new Bundle();
        
        Test4TransformerFragment fragment = new Test4TransformerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_test_4, null);

        mButton1 = (Button) root.findViewById(R.id.button_test4_1);
        mButton2 = (Button) root.findViewById(R.id.button_test4_2);
        mButton3 = (Button) root.findViewById(R.id.button_test4_3);
        return root;
